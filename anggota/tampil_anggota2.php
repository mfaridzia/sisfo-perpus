...
$query=mysql_query("select * from anggota order by nama_anggota limit $start,$per_page");
$i=1;
while($data=mysql_fetch_assoc($query)){
	echo "<tr>
		 <td>".$i."</td>
		 <td><img style='width:50px; height:50px; border-radius:5px;' src=\"../foto_siswa/".$data['foto']."\"></td>
		 ...
		 <td>".$data['alamat']."</td>
		 <td>
		 <a href=\"view.php?id=".$data['id']."\">V</a> ||
		 <a href=\"form_edit_anggota.php?id=".$data['id']."\">E</a> ||
		 <a href=\"delete_anggota.php?id=".$data['id']."\">D</a>
		 </td></tr>";
		$i++;
	 }
