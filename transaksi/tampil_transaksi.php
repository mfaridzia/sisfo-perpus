...
$per_page=3;
$page_query=mysql_query("select count(*)from transaksi");
$pages=ceil(mysql_result($page_query,0)/$per_page);
$page=(isset($_GET['page'])) ? (int)$_GET['page'] : 1;
$start=($page-1) * $per_page;

$query=mysql_query("select * from transaksi order by nama_peminjam limit $start,$per_page");
$i=1;
while($data=mysql_fetch_assoc($query)){
	echo "<tr>
		 ...
		 <td>".$data['denda']."</td>
		 <td>
		 <a href=\"form_edit_transaksi.php?id=".$data['id']."\">Edit</a> ||
		 <a href=\"delete_transaksi.php?id=".$data['id']."\">Delete</a>
		 </td></tr>";
		$i++;
	 }
