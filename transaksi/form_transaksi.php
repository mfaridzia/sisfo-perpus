...
<body>
	...
	$insert="insert into transaksi(nama_peminjam,kelas,judul_buku,tgl_pinjam,tgl_kembali,denda)values('$nama_peminjam','$kelas','$judul_buku','$tgl_pinjam','$tgl_kembali','$denda')";
	...
	<td>Nama Peminjam</td>
	<td>:</td>
	<td><input type="text" name="nama_peminjam" placeholder="" required/></td>
	</tr>
	<tr>
	<td>Kelas Anda</td>
	<td>:</td>
	...
	<td>Judul Buku</td>
	<td>:</td>
	<td><input type="text" name="judul_buku" placeholder="" required/></td>
	</tr>
	<tr>
	<td>Tgl Pinjam</td>
	<td>:</td>
	...
	<td>Denda</td>
	<td>:</td>
	<td><input type="text" name="denda" placeholder="" required/></td>
	</tr>
	<tr>
	<td></td>
	<td></td>
