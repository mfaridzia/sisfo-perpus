...
$cari=mysql_query("select * from anggota where nama_anggota like '%$q%' or kelas like '%$q%' or jk like '%$q%'
or tgl_lahir like '%$q%' or alamat like '%$q%'");
...
$i=1; 
while($data=mysql_fetch_assoc($cari)){
echo "<tr>
<td>$i</td>  
