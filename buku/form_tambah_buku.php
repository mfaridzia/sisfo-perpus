...
<body>
	...
	<td>Nama Buku</td>
	<td>:</td>
	<td><input type="text" name="nama_buku" placeholder="" required/></td>
	</tr>
	<tr>
	<td>Kode Buku</td>
	<td></td>
	<td><input type="text" name="kode_buku" placeholder="" required/></td>
	</tr>
	<tr>
	<td>Penerbit</td>
	<td>:</td>
	...
	<td>Tahun Terbit</td>
	<td>:</td>
	<td><input type="text" name="tahun_terbit" placeholder="" required/></td>
	</tr>
	<tr>
	<td>Pengarang</td>
	<td>:</td>
